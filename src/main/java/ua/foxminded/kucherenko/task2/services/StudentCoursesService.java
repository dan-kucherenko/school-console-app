...
public class StudentCoursesService {
    ...
    @Autowired
    public StudentCoursesService(StudentRepository studentRepository, CourseRepository courseRepository) {
    ...
    public void addStudentToCourse(AddStudentToCourseData data) {
        ...
        if (exists(studentId, data.getCourseId())) {
    ...
    private boolean exists(int studentId, int courseId) {
        ...
        if (student.isEmpty()) {
            throw new IllegalArgumentException("Student with given id wasn't found");
        }
        Optional<Course> course = courseRepository.findById(courseId);
        if (course.isEmpty()) {
            throw new IllegalArgumentException("Course with given id wasn't found");
        }
